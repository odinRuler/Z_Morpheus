...
**Live scan results**: See `references/scan-2026-06-29.md` for the most recent scan. Previous scans: `scan-2026-06-26.md`, `scan-2026-06-25.md`, `scan-2026-06-24.md`, `scan-2026-06-05.md`, `scan-2026-06-04.md`, `scan-2026-06-03.md`. For scan execution patterns, see `references/scan-work Subsequent scans should create new dated files.
...
# 🔍 Scan Job — 30 juin 2026

## 🇫🇷 PARIS

**1. Ardian — 6-Month Stage - Paris — Dès que possible**
- 6 mois, Paris — démarrage ASAP
- Private Equity — leader européen (€150bn+ AUM, top 5 PE Europe)
...
- Private Equity — cabinet d'affaires indépendant top-tier
- Stage PE très prestigieux, référence M&A en Europe
...
- M&A Advisory — banque d'affaires internationale en croissance
...
**4. Greenhill — Off-cycle M&A 6-month Internship**
- France (Paris) — démarrage flexible
- M&A — boutique IB de premier plan, pure-play advisory
...
- London — démarrage septembre 2026 ou flexible
...
**2. Guggenheim Partners — IB Analyst Intern – Financial Sponsors Group (London)**
- London — démarrage 2026/2027
- IB — Financial Sponsors Group (PE coverage)
- Boutique IB de haut niveau, fort réseau PE
- Source : [Trackr UK](https://app.the-trackr.com/uk-finance/off-cycle-internships)
...
- Investment Banking — mid-tier IB diversifiée, visa sponsorship
...
- Summer 2027, New York
- Growth Equity — top-tier ($90bn+ AUM), tech/healthcare/financial services
- Source : [Trackr US](https://app.the-trackr.com/us-finance-2027/summer-internships)

**3. Orion Group — Private Equity Summer Analyst (2027, New York)**
- Summer 2027, New York
- Private Equity mid-market — $50bn+ AUM
- Source : [Trackr US](https://app.the-trackr.com/us-finance-2027/summer-internships)

**4. GCM Grosvenor — 2027 PE Investments Summer Intern (New York)**
- Summer 2027, New York
- PE Investments — fund-of-funds + direct, $70bn+ AUM
- Source : [Trackr US](https://app.the-trackr.com/us-finance-2027/summer-internships)

---

## 📊 Nouveautés vs scan 2026-06-29

| Offre | Statut |
|-------|--------|
| Ardian Paris 6-Month Stage | 🆕 Nouveau |
| Lazard PE Paris Jan 2027 | 🆕 Nouveau |
| Macquarie M&A Paris 2027 | 🆕 Nouveau |
| Greenhill M&A France | 🆕 Nouveau |
| Ardian Buyout London | 🆕 Nouveau (distinct infra) |
| Guggenheim FSG London | 🆕 Nouveau |
| Blackstone Private Credit London | 🆕 Nouveau (distinct PE Summer) |
| CVC London Off-Cycle | 🆕 Nouveau |
| Jefferies NYC 2027 Summer | 🆕 Nouveau |
| General Atlantic NYC 2027 | 🆕 Nouveau |
| Orion Group NYC 2027 PE | 🆕 Nouveau |
| GCM Grosvenor NYC 2027 PE | 🆕 Nouveau |

## ⚠️ Deadlines imminentes
- **Blackstone Private Credit London** : 31 juillet 2026
- **Goldman NYC Summer Analyst** : apps ouvrent 15 août 2026
- **Ardian Infrastructure London** : démarrage ASAP
